...
public class Hero {
    ...
    private String nama;
    private ArrayList<Item> arrItem; //polimorpisme untuk Item namun dalam player kemungkinan tidak memiliki itemPintu tapi ini bisa digunakan untuk polimorpisme jikalau nanti ada itemMkanan contohnya
    ...
    public void pilihanAksi() {
        ...
        if (pil == pilInfoPlayer) {
            ...
            objItemPilih.prosesAksi(subPil); //aksi item tergantung item merupakan child atau parent jika chil akan memanggil dari fungsi yang di Override
        }
    }
